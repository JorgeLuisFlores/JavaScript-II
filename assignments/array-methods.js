...
let allUpper = [];
    ...
    runners.map(function (runner, index) {
        allUpper[index] = runner.first_name.toUpperCase();
});
...
let ticketPriceTotal = [];
    ...
    ticketPriceTotal = runners.reduce(function (totalValue, runner) {
...
let topDonations = []
    ...
    topDonations = runners.filter(function (runner){
...
let allLower = []
    ...
    runners.map(function (runner, index) {
        allLower[index] = runner.company_name.toLowerCase();
    });
...
let mainInfo = []
    ...
    runners.forEach(function(runner){
        mainInfo.push(runner.first_name + " " + runner.email + " " + runner.company_name);
    });
